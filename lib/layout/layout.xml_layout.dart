...
import 'package:retroconfig/widgets/better_refresh_indicator.dart';
...
Register register = Register(() {
  ...
  XmlLayout.register("ExpandableText", (node, key) {
    return ExpandableText(node.s<String>("arg:0") ?? node.t<String>(),
        key: key,
        expandText: node.s<String>("expandText"),
        collapseText: node.s<String>("collapseText"),
        expanded: node.s<bool>("expanded", false),
        onExpandedChanged: node.s<void Function(bool)>("onExpandedChanged"),
        linkColor: node.s<Color>("linkColor"),
        linkEllipsis: node.s<bool>("linkEllipsis", true),
        linkStyle: node.s<TextStyle>("linkStyle"),
        prefixText: node.s<String>("prefixText"),
        prefixStyle: node.s<TextStyle>("prefixStyle"),
        onPrefixTap: node.s<void Function()>("onPrefixTap"),
        urlStyle: node.s<TextStyle>("urlStyle"),
        onUrlTap: node.s<void Function(String)>("onUrlTap"),
        hashtagStyle: node.s<TextStyle>("hashtagStyle"),
        onHashtagTap: node.s<void Function(String)>("onHashtagTap"),
        mentionStyle: node.s<TextStyle>("mentionStyle"),
        onMentionTap: node.s<void Function(String)>("onMentionTap"),
        expandOnTextTap: node.s<bool>("expandOnTextTap", false),
        collapseOnTextTap: node.s<bool>("collapseOnTextTap", false),
        style: node.s<TextStyle>("style"),
        textDirection: node.s<TextDirection>("textDirection"),
        textAlign: node.s<TextAlign>("textAlign"),
        textScaleFactor: node.s<double>("textScaleFactor"),
        maxLines: node.s<int>("maxLines", 2),
        animation: node.s<bool>("animation", false),
        animationDuration: node.s<Duration>("animationDuration"),
        animationCurve: node.s<Curve>("animationCurve"),
        semanticsLabel: node.s<String>("semanticsLabel"));
  });
  XmlLayout.register("DownloadWidget", (node, key) {
    return DownloadWidget(
        builder: node
            .s<Widget Function(BuildContext, Map<String, dynamic>)>("builder"),
        context: node.s<Context>("context"),
